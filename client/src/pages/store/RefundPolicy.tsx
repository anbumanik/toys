  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center py-20 px-4">
      <div className="max-w-lg text-center animate-fade-in-up">
        <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-5xl mx-auto mb-6 shadow-xl">
          ↩️
        </div>
        <h1 className="text-4xl font-extrabold text-gray-900 mb-3" style={{ fontFamily: 'Outfit' }}>
          Refund Policy
        </h1>
        <p className="text-gray-500 text-lg mb-8 leading-relaxed">Our hassle-free returns and refund policy explained.</p>
        <a
          href="/"
